import { c as createWebWorker, e as editor, U as Uri, a as MarkerTag, M as MarkerSeverity, l as languages, t as typescriptDefaults, R as Range } from './editor.main-B-9RBUSu.js';
    ...
    if (!this._client) {
      this._client = (async () => {
        this._worker = createWebWorker({
          ...
          createWorker: () => new Worker(new URL(/* @vite-ignore */ "/neno/assets/ts.worker-Cu3ufg5x.js", import.meta.url), { type: "module" }),
          label: this._modeId,
          keepIdleModels: true,
