import { a as MarkerSeverity, c as Range, f as Uri, h as languages, o as MarkerTag, p as editor } from "./editor.api2-J5VvnjYP.js";
import { n as typescriptDefaults } from "./monaco.contribution-Bbm_3Z_n.js";
		...
		if (!this._client) this._client = (async () => {
			this._worker = createWebWorker({
				...
				createWorker: () => new Worker(new URL(
					/* @vite-ignore */
					"/neno/assets/ts.worker-Dsc11SK3.js",
					"" + import.meta.url
				), { type: "module" }),
				label: this._modeId,
				keepIdleModels: true,
...
//#endregion
//#region node_modules/monaco-editor/esm/vs/language/typescript/lib/lib.index.js
var libFileSet = {};
